...
FAIL_DIR = 'H:/Test Wrapper Result/fail images'
PASS_DIR = 'H:/Test Wrapper Result/pass images'
...
BASE_DIR = 'H:/Test Wrapper Result/Dataset_Train_and_Test/'
...
def images_distributions(fail_set, pass_set, in_train, in_val, in_test):
    # FAIL
...
images_distributions(fail_set=[10000, 2000, 9000], pass_set=[10000, 2000, 9000], in_train=True, in_val=True, in_test=True)